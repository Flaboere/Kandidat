...
public class VectorØvelse3A : MonoBehaviour 
{
	...
	{
		// 2d Kasse
		Debug.DrawLine(new Vector3(0,0,0), new Vector3(0,2,0), Color.red);
		Debug.DrawLine(new Vector3(0,2,0), new Vector3(2,2,0), Color.red);
		Debug.DrawLine(new Vector3(2,2,0), new Vector3(2,0,0), Color.red);
